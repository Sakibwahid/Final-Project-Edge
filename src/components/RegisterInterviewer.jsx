            ...
            <form onSubmit={handleSubmit}>
                <div className="md:flex gap-4">
                    <div className="form-control w-full">
                        ...
                        <input type="text" name="firstName" className="input input-sm input-bordered flex" />
                    </div>
                    <div className="form-control w-full">
                        <label className="label">
                            <span className="label-text">Last Name</span>
                        </label>
                        <input type="text" name="lastName" className="input input-sm input-bordered flex" />
                    </div>
                </div>
                <div className="md:flex gap-4">
                    <div className="form-control w-full">
                ...
                <div className="md:flex gap-4">
                    <div className="form-control w-full">
                        ...
                        <input type="text" name="category" className="input input-sm input-bordered" />
                    </div>
                    <div className="form-control w-full">
                        <label className="label">
                            <span className="label-text">Skill</span>
                        </label>
                        <input type="text" name="skill" className="input input-sm input-bordered" />
                    </div>
                </div>
                <div className="md:flex gap-4">
                    <div className="form-control w-full">
